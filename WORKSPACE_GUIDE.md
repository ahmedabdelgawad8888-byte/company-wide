...
## Core Team Workspace
**Purpose:** one place for the people who unblock cross-functional work.
...
- Overdue actions
- Upcoming decisions
- Core Team member ownership cards

**Navigation:** Core Team Home · Shared Priorities · Decisions & Meetings · Blockers & Overdue · Team Calendar · Automation Center · Activity & Changes · Core Team Reports
...
**Working rule:** joining, onboarding, attendance, interviews and employee actions stay assigned with a due date.

## Data Analysis Workspace
**Purpose:** track analysis from request through validated delivery.

**Navigation:** Data Home · Analysis Queue · Reports & Insights · Data Files · Delivery Calendar · Data Activity

**Working rule:** every analysis starts with a clear business question and closes only after the output is validated and delivered.
